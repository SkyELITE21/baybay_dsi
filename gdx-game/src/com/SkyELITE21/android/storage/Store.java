...
public abstract class Store implements IStore
{
	...
	public static final String STRING = "§",INT = "*",LONG ="|",BOOLEAN ="?",
	SHORT = "`",BYTE = "~",FLOAT = "•",DOUBLE = "°",
	ARRAY = "∆";
	private String SAVE_NAME,PKG_NAME,EXTENSION = ".sus", head = "<sus version=\"" + VERSION + "\">"
	, end = "</sus>";
	public Store(String pkg_name,String str,int type)
	{
	...
	public String getStoredString(String str)
	{
		...
		try
		{
			...
			{
				return fr = r.substring(r.indexOf("<"+STRING+" name=\""+str+"\">") + str.length() + 11,r.indexOf("</"+STRING+">"));
			}
		}
		catch (IOException e)
		{}
	...
	public int getStoredInt(String str)
	{
		...
		try
		{
			...
			{
				return fr = Integer.parseInt(r.substring(r.indexOf("<"+INT+" name=\""+str+"\">") + str.length() + 11,r.indexOf("</"+INT+">")));
			}
		}
		catch (IOException e)
		{}
	...
	public boolean getStoredBoolean(String str)
	{
		...
		try
		{
			...
			{
				return fr = Boolean.parseBoolean(r.substring(r.indexOf("<"+BOOLEAN+" name=\""+str+"\">") + str.length() + 11,r.indexOf("</"+BOOLEAN+">")));
			}
		}
		catch (IOException e)
		{}
	...
	public long getStoredLong(String str)
	{
		...
		try
		{
			...
			{
				return fr = Long.parseLong(r.substring(r.indexOf("<"+LONG+" name=\""+str+"\">") + str.length() + 11,r.indexOf("</"+LONG+">")));
			}
		}
		catch (IOException e)
		{}
	...
	public short getStoredShort(String str)
	{
		...
		try
		{
			...
			{
				return fr = Short.parseShort(r.substring(r.indexOf("<"+SHORT+" name=\""+str+"\">") + str.length() + 11,r.indexOf("</"+SHORT+">")));
			}
		}
		catch (IOException e)
		{}
	...
	public byte getStoredByte(String str)
	{
		...
		try
		{
			...
			{
				return fr = Byte.parseByte(r.substring(r.indexOf("<"+BYTE+" name=\""+str+"\">") + str.length() + 11,r.indexOf("</"+BYTE+">")));
			}
		}
		catch (IOException e)
		{}
	...
	public float getStoredFloat(String str)
	{
		...
		try
		{
			...
			{
				return fr = Float.parseFloat(r.substring(r.indexOf("<"+FLOAT+" name=\""+str+"\">") + str.length() + 11,r.indexOf("</"+FLOAT+">")));
			}
		}
		catch (IOException e)
		{}
	...
	public double getStoredDouble(String str)
	{
		...
		try
		{
			...
			{
				return fr = Double.parseDouble(r.substring(r.indexOf("<"+DOUBLE+" name=\""+str+"\">") + str.length() + 11,r.indexOf("</"+DOUBLE+">")));
			}
		}
		catch (IOException e)
		{}
	...
	public class Editor implements IEditor
	{
		...
		{
			// TODO: Implement this method
			String a = "",b = "<" + STRING + " name=\"" + str + "\">",str3 = "<" + STRING + " name=\"" + str + "\">" + str2 + "</" + STRING + ">";
			try
			{
		...
		{
			String a = "",b = "<" + INT + " name=\"" + str + "\">",str3 = "<" + INT + " name=\"" + str + "\">" + p0 + "</" + INT + ">";
			try
			{
				int length = head.length();
				long i = length + 1,skip;
		...
		{
			String a = "",b = "<" + BOOLEAN + " name=\"" + str + "\">",str3 = "<" + BOOLEAN + " name=\"" + str + "\">" + bool + "</" + BOOLEAN + ">";
			try
			{
				int length = head.length();
				long i = length + 1,skip;
		...
		{
			String a = "",b = "<" + LONG + " name=\"" + str + "\">",str3 = "<" + LONG + " name=\"" + str + "\">" + p0 + "</" + LONG + ">";
			try
			{
				int length = head.length();
				long i = length + 1,skip;
		...
		{
			String a = "",b = "<" + SHORT + " name=\"" + str + "\">",str3 = "<" + SHORT + " name=\"" + str + "\">" + p0 + "</" + SHORT + ">";
			try
			{
				int length = head.length();
				long i = length + 1,skip;
		...
		{
			String a = "",b = "<" + BYTE + " name=\"" + str + "\">",str3 = "<" + BYTE + " name=\"" + str + "\">" + p0 + "</" + BYTE + ">";
			try
			{
				int length = head.length();
				long i = length + 1,skip;
		...
		{
			String a = "",b = "<" + FLOAT + " name=\"" + str + "\">",str3 = "<" + FLOAT + " name=\"" + str + "\">" + p0 + "</" + FLOAT + ">";
			try
			{
				int length = head.length();
				long i = length + 1,skip;
		...
		{
			String a = "",b = "<" + DOUBLE + " name=\"" + str + "\">",str3 = "<" + DOUBLE + " name=\"" + str + "\">" + p0 + "</" + DOUBLE + ">";
			try
			{
				int length = head.length();
				long i = length + 1,skip;
